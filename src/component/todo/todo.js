  ...
  return(
    <main>
      <form onSubmit={handelSubmit}>
        ...
        <input type='number' onChange={addDifficulty} placeholder = 'Difficulty 1-5' max={5} min={1} required/>
        ...
        toDoList.map((toDo,idx)=>{
          return (
            <div className="toDoList">
              ...
              <button className='complete' style={{display:disable, color:coloring}} name={toDo[0]} value={toDo[1]} title={toDo[2]} onClick={completeTask}>completed</button>
            </div>
          );
        })
      }
